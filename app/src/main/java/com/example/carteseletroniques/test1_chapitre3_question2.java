...
public class test1_chapitre3_question2 extends AppCompatActivity {
    Button b1,b2,b3,b4;
    int i=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test1_chapitre3_question2);
        ...
        b1.setOnClickListener(v -> {
            ...
            i=i+1;
            if(i>=2)
            {Intent intent=new Intent(getApplicationContext(),test1_chapitre3_question3.class);
            startActivity(intent);}

        });
        b2.setOnClickListener(v -> {
            b2.setBackgroundColor(Color.rgb(7,85,7));
            mediavrai.start();
            Toast.makeText(getApplicationContext()," Bravo réponse correcte",Toast.LENGTH_LONG).show();
            i=i+1;
            if(i>=2)
