...
public class test3_chapitre3 extends AppCompatActivity {
    Button b1,b2,b3,b4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test3_chapitre3);
        ...
        b3.setOnClickListener(v -> {
            ...
            Intent intent=new Intent(getApplicationContext(),test3_chapitre3_question2.class);
