...
public class test3_chapitre3_question2 extends AppCompatActivity {
    Button b1,b2,b3,b4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test3_chapitre3_question2);
        ...
        b4.setOnClickListener(v -> {
            ...
            Intent intent=new Intent(getApplicationContext(),test3_chapitre3_question3.class);
